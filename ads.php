            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="" method="GET">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control"  placeholder="Website link" name="link" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <tbody>
                        <?php foreach(ad() as $ad){
                            ...
                            <tr>
                                ...
                                <a href='ads-delete.php?id=<?php echo $ad["id"]?>' class="btn btn-sm btn-outline-danger "><i class="feather-trash-2"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
